...
const Modal = (props) => {
    ...
    return (                                      //unmountOnExit
        <CSSTransition  timeout={duration} in={props.show} 
            onEnter={() => props.setShowTrigger(false)} onExited={() => props.setShowTrigger(true)}
            classNames='modal' mountOnEnter unmountOnExit>  
...
export default CSSTransitionModul ;
